...
# Red Teaming Agent with custom attack prompts
red_team_agent = RedTeam(
    azure_ai_project=azure_ai_project,
    credential=DefaultAzureCredential(),
...
chat_target = OpenAIChatTarget(
    ...
    endpoint=f"{os.environ.get('gpt_endpoint').rstrip('/')}/openai/deployments/{os.environ.get('gpt_deployment')}",
    api_key=os.environ.get("gpt_api_key"),
    httpx_client_kwargs={"default_query": {"api-version": os.environ.get("gpt_api_version")}},
)
